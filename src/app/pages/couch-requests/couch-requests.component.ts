...
export class CouchRequestsComponent {
    ...
    requestStatus: 'CREATED' | 'ACCEPTED' | 'DECLINED' | 'CANCELED' | 'COMPLETED' = 'ACCEPTED';
    ...
    setRequestStatus(reqStatus: 'CREATED' | 'ACCEPTED' | 'DECLINED' | 'CANCELED' | 'COMPLETED') {
        this.requestStatus = reqStatus;
        this.loadData(reqStatus);
    }

    loadData(reqStatus: 'CREATED' | 'ACCEPTED' | 'DECLINED' | 'CANCELED' | 'COMPLETED') {
        this.requestsService.getIncomingRequests({
            page: this.page,
            size: this.size,
    ...
    updateCouchRequest(couchRequest: Request,
    ...
    giveFeedback(id?: Request) {
        console.log(`Feedback for ${id} couch request`);
    }
}
